...
public class NewRelicDeinstrumentTask extends NewRelicTask
{
    ...
    public Object newRelicInsturmentTask()
    {
        ...
        if(!BytecodeInterface8.isOrigZ() || __$stMC || BytecodeInterface8.disabledStandardMetaClass())
        {
            ...
            {
                Object obj = acallsite[1].call(acallsite[2].call(agentArgs, ";"), extraArgs);
        ...
        if(ScriptBytecodeAdapter.compareNotEqual(extraArgs, null))
        {
            Object obj1 = acallsite[3].call(acallsite[4].call(agentArgs, ";"), extraArgs);
            agentArgs = (String)ScriptBytecodeAdapter.castToType(obj1, $get$$class$java$lang$String());
            obj1;
        }
        acallsite[5].call(acallsite[6].callGroovyObjectGetProperty(this), acallsite[7].call("[newrelic] Attaching to process for deinstrumentation ", acallsite[8].call(acallsite[9].callGroovyObjectGetProperty(this))));
        obj2 = acallsite[10].callCurrent(this, agentArgs);
        ...
        catch(Exception exception1)
        {
            ...
            acallsite[11].call(acallsite[12].callGroovyObjectGetProperty(this), "[newrelic] Error encountered while loading the New Relic agent", e);
            throw (Throwable)acallsite[13].callConstructor($get$$class$java$lang$RuntimeException(), e);
        }
        Exception exception;
        exception;
        throw exception;
    ...
    {
        CallSite acallsite[] = $getCallSiteArray();
        return ScriptBytecodeAdapter.invokeMethodOnCurrentN($get$$class$com$newrelic$agent$android$NewRelicDeinstrumentTask(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[] {
            name
        }, new String[] {
            "", ""
    ...
    public void this$dist$set$4(String name, Object value)
    {
        CallSite acallsite[] = $getCallSiteArray();
        Object obj = value;
        ScriptBytecodeAdapter.setGroovyObjectField(obj, $get$$class$com$newrelic$agent$android$NewRelicDeinstrumentTask(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[] {
            name
        }, new String[] {
            "", ""
    ...
    {
        CallSite acallsite[] = $getCallSiteArray();
        return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$com$newrelic$agent$android$NewRelicDeinstrumentTask(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[] {
            name
        }, new String[] {
            "", ""
        }), $get$$class$java$lang$String()));
    ...
    {
        if(getClass() != $get$$class$com$newrelic$agent$android$NewRelicDeinstrumentTask())
    ...
    private static CallSiteArray $createCallSiteArray()
    {
        ...
        return new CallSiteArray($get$$class$com$newrelic$agent$android$NewRelicDeinstrumentTask(), as);
    }
    ...
    public static long __timeStamp__239_neverHappen1416597642138;
    ...
    static 
    {
        ...
        __timeStamp__239_neverHappen1416597642138 = long1.longValue();
        Long _tmp = long1;
        Long long2 = (Long)DefaultTypeTransformation.box(0x149d3cc9b9aL);
