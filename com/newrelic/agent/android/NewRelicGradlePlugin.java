...
public class NewRelicGradlePlugin
    implements Plugin, GroovyObject
{
    ...
    public void apply(Project project1)
    {
        ...
        project;
        CallSite acallsite[] = $getCallSiteArray();
        Object obj = acallsite[0].call((Project)project.get());
        logger = (Logger)ScriptBytecodeAdapter.castToType(obj, $get$$class$org$gradle$api$logging$Logger());
        obj;
        acallsite[1].call(logger, "[newrelic] New Relic plugin loaded.");

        // translate
        Project project = project1;
        final Logger logger = project.get().getLogger;
            ...
            implements GeneratedClosure
        {
            ...
            public Object doCall(Object it)
            {
                ...
                {
                    acallsite1[1].call(project.get(),
                            ScriptBytecodeAdapter.createMap(
                                    new Object[] { "type", $get$$class$com$newrelic$agent$android$NewRelicInstrumentTask()}
                            ),
                            "newRelicInstrumentTask");
                    acallsite1[2].call(project.get(), ScriptBytecodeAdapter.createMap(new Object[] {
                        "type", $get$$class$com$newrelic$agent$android$NewRelicDeinstrumentTask()
                    }), "newRelicDeinstrumentTask");

                    // project.get().task(new  Map({"type" => new NewRelicInstrumentTask()},"newRelicInstrumentTask")
                    // project.get().task(new  Map({"type", new NewRelicDeinstrumnetTask()} => "newRelicDeinstrumentTask")
                        ...
                        implements GeneratedClosure
                    {
                        ...
                        public Object doCall(Object variant)
                        {
                            ...
                            //translate
                            dex.variant.dependsOn("newRelicInstrumentTask");
                            dex.variant.finalizedBy("newRelicDeinstrumentTask");
                            return logger.info("[newrelic] Added instrumentation tasks to " + variant.name + " variant.");
                        }
                    ...
                    acallsite1[3].call(
                            acallsite1[4].callGetProperty(acallsite1[5].callGroovyObjectGetProperty(this)),
                            new _apply_closure1_closure2(this, getThisObject())
                    );



                    //trnaslate
                    this.android.applicationVariants.all(new _apply_closure1_closure2)
                    ...
                    return acallsite1[6].call(
                            acallsite1[7].callGetProperty(acallsite1[8].callGroovyObjectGetProperty(this)),
                            new _apply_closure1_closure3(this, getThisObject())
                    );
                    //translate
                    return  this.android.testVariants.all(new _apply_closure1_closure3);
            ...
            {
                CallSite acallsite1[] = $getCallSiteArray();
                return acallsite1[9].callCurrent(this,
                        ScriptBytecodeAdapter.createPojoWrapper(null, $get$$class$java$lang$Object()));
            }
        ...
        acallsite[2].call((Project)project.get(),
                (Project)project.get(),
                new _apply_closure1(this, this, project)
        );

        project.configure(project,_apply_closure1 )
        return;
    }
